    ...
    return (
      <View style={styles.external_container}>
        ...
        <View style={styles.item_image}>
          <Image
            source={require('../image/noodle.png')}
        ...
        <View style={styles.order_item}>
          <View style={styles.foodname_view}>
            ...
            <View style={styles.foodprice}>
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                />
                <Text style={{fontSize: RFValue(12, 580), margin: 4}}>
                  4.8(523)
                </Text>
              </View>
            </View>
          ...
          <View style={styles.details}>
            <Text style={{fontSize: RFValue(15, 580), fontWeight: '600'}}>
              Details
            </Text>
            <Text style={{fontSize: RFValue(15, 580)}}> {'>'} </Text>
          </View>
          <View style={styles.details}>
          ...
          <View style={styles.footer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                Alert.alert(
                  ` ${this.state.items} Item added successfully to cart`,
                );
              }}>
              <Text
                style={{
